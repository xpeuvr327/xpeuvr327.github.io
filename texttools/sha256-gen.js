document.addEventListener("DOMContentLoaded", function() {
  ...
  const calculateHashButton = document.getElementById("calculateHash");
  ...
  calculateHashButton.addEventListener("click", function() {
    ...
    if (!asciiRegex.test(input)) {
      errorMessage.textContent = "Erreur: L'entrée  contient des caractères non-ASCII.";
    } else {
